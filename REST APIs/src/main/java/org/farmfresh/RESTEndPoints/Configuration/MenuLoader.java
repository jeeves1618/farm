...
public class MenuLoader implements ApplicationListener<ApplicationReadyEvent> {
    ...
    public void onApplicationEvent(ApplicationReadyEvent event) {
        ...
        try {
            menuList = objectMapper.readValue(new URL("https://raw.githubusercontent.com/jeeves1618/farm/master/REST%20APIs/src/main/resources/static/data/item.json?token=GHSAT0AAAAAABZIF6WCOPSBNR2DYUNGZEDOY6VCKWQ"), ArrayList.class);
        } catch (IOException e) {
            e.printStackTrace();
        }
